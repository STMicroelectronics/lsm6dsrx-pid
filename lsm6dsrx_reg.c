                                  ...
                                  lsm6dsrx_odr_xl_t val)
{
  ...
  lsm6dsrx_emb_fsm_enable_t fsm_enable = {0};
  lsm6dsrx_fsm_odr_t fsm_odr = {0};
  uint8_t mlc_enable = 0;
  lsm6dsrx_mlc_odr_t mlc_odr = {0};
  lsm6dsrx_ctrl1_xl_t ctrl1_xl = {0};
  int32_t ret = 0;
...
int32_t lsm6dsrx_xl_flag_data_ready_get(const stmdev_ctx_t *ctx,
                                        uint8_t *val)
{
  lsm6dsrx_status_reg_t status_reg = {0};
  int32_t ret = {0};
                                     ...
                                     int8_t *val)
{
  ...
  ret = lsm6dsrx_write_reg(ctx, LSM6DSRX_X_OFS_USR, (uint8_t *)val, 1);
                                     ...
                                     int8_t *val)
{
  ...
  ret = lsm6dsrx_read_reg(ctx, LSM6DSRX_X_OFS_USR, (uint8_t *)val, 1);
                                     ...
                                     int8_t *val)
{
  ...
  ret = lsm6dsrx_write_reg(ctx, LSM6DSRX_Y_OFS_USR, (uint8_t *)val, 1);
                                     ...
                                     int8_t *val)
{
  ...
  ret = lsm6dsrx_read_reg(ctx, LSM6DSRX_Y_OFS_USR, (uint8_t *)val, 1);
                                     ...
                                     int8_t *val)
{
  ...
  ret = lsm6dsrx_write_reg(ctx, LSM6DSRX_Z_OFS_USR, (uint8_t *)val, 1);
                                     ...
                                     int8_t *val)
{
  ...
  ret = lsm6dsrx_read_reg(ctx, LSM6DSRX_Z_OFS_USR, (uint8_t *)val, 1);
...
{
  lsm6dsrx_ctrl10_c_t ctrl10_c = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_emb_func_src_t emb_func_src = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_internal_freq_fine_t internal_freq_fine = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_func_cfg_access_t func_cfg_access = {0};
  int32_t ret = {0};
                             ...
                             uint8_t *buf, uint8_t len)
{
  ...
  lsm6dsrx_page_sel_t page_sel = {0};
  lsm6dsrx_page_address_t page_address = {0};
  uint8_t msb = {0};
  uint8_t lsb = {0};
  int32_t ret = {0};
  uint8_t i = {0};
...
{
  lsm6dsrx_counter_bdr_reg1_t counter_bdr_reg1 = {0};
  int32_t ret = {0};
...
int32_t lsm6dsrx_device_id_get(const stmdev_ctx_t *ctx, uint8_t *val)
{
  ...
  ret = lsm6dsrx_read_reg(ctx, LSM6DSRX_WHO_AM_I, val, 1);
...
{
  lsm6dsrx_ctrl8_xl_t ctrl8_xl = {0};
  int32_t ret = {0};
                                       ...
                                       lsm6dsrx_hp_slope_xl_en_t *val)
{
  ...
  else
  {
    ...
    {
      case 0x00:
        *val = is_low_pass == 1u ? LSM6DSRX_LP_ODR_DIV_4 : LSM6DSRX_SLOPE_ODR_DIV_4;
        break;

      case 0x01:
        *val = is_low_pass == 1u ? LSM6DSRX_LP_ODR_DIV_10 : LSM6DSRX_HP_ODR_DIV_10;
        break;

      case 0x02:
        *val = is_low_pass == 1u ? LSM6DSRX_LP_ODR_DIV_20 : LSM6DSRX_HP_ODR_DIV_20;
        break;

      case 0x03:
        *val = is_low_pass == 1u ? LSM6DSRX_LP_ODR_DIV_45 : LSM6DSRX_HP_ODR_DIV_45;
        break;

      case 0x04:
        *val = is_low_pass == 1u ? LSM6DSRX_LP_ODR_DIV_100 : LSM6DSRX_HP_ODR_DIV_100;
        break;

      case 0x05:
        *val = is_low_pass == 1u ? LSM6DSRX_LP_ODR_DIV_200 : LSM6DSRX_HP_ODR_DIV_200;
        break;

      case 0x06:
        *val = is_low_pass == 1u ? LSM6DSRX_LP_ODR_DIV_400 : LSM6DSRX_HP_ODR_DIV_400;
        break;
...
{
  lsm6dsrx_tap_cfg0_t tap_cfg0 = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_pin_ctrl_t pin_ctrl = {0};
  int32_t ret = {0};
...
int32_t lsm6dsrx_aux_xl_flag_data_ready_get(const stmdev_ctx_t *ctx,
                                            uint8_t *val)
{
  lsm6dsrx_status_spiaux_t status_spiaux = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_int_ois_t int_ois = {0};
  lsm6dsrx_ctrl1_ois_t ctrl1_ois = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_ctrl2_ois_t ctrl2_ois = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_ctrl3_ois_t ctrl3_ois = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_i3c_bus_avb_t i3c_bus_avb = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_ctrl9_xl_t ctrl9_xl = {0};
  lsm6dsrx_i3c_bus_avb_t i3c_bus_avb = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_tap_cfg2_t tap_cfg2 = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_wake_up_dur_t wake_up_dur = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_wake_up_ths_t wake_up_ths = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_tap_cfg1_t tap_cfg1 = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_tap_ths_6d_t tap_ths_6d = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_int_dur2_t int_dur2 = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_free_fall_t free_fall = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_fifo_ctrl1_t fifo_ctrl1 = {0};
  lsm6dsrx_fifo_ctrl2_t fifo_ctrl2 = {0};
  int32_t ret = {0};
...
int32_t lsm6dsrx_compression_algo_init_set(const stmdev_ctx_t *ctx,
                                           uint8_t val)
{
  lsm6dsrx_emb_func_init_b_t emb_func_init_b = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_fifo_ctrl2_t fifo_ctrl2 = {0};
  lsm6dsrx_emb_func_en_b_t emb_func_en_b = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_fifo_ctrl3_t fifo_ctrl3 = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_fifo_ctrl4_t fifo_ctrl4 = {0};
  int32_t ret = {0};
...
int32_t lsm6dsrx_batch_counter_threshold_set(const stmdev_ctx_t *ctx,
                                             uint16_t val)
{
  lsm6dsrx_counter_bdr_reg2_t counter_bdr_reg1 = {0};
  lsm6dsrx_counter_bdr_reg2_t counter_bdr_reg2 = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_fifo_data_out_tag_t fifo_data_out_tag = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_emb_func_fifo_cfg_t emb_func_fifo_cfg = {0};
  int32_t ret = {0};
...
int32_t lsm6dsrx_sh_batch_slave_0_set(const stmdev_ctx_t *ctx,
                                      uint8_t val)
{
  lsm6dsrx_slv0_config_t slv0_config = {0};
  int32_t ret = {0};
...
int32_t lsm6dsrx_sh_batch_slave_1_set(const stmdev_ctx_t *ctx,
                                      uint8_t val)
{
  lsm6dsrx_slv1_config_t slv1_config = {0};
  int32_t ret = {0};
...
int32_t lsm6dsrx_sh_batch_slave_2_set(const stmdev_ctx_t *ctx,
                                      uint8_t val)
{
  lsm6dsrx_slv2_config_t slv2_config = {0};
  int32_t ret = {0};
...
int32_t lsm6dsrx_sh_batch_slave_3_set(const stmdev_ctx_t *ctx,
                                      uint8_t val)
{
  lsm6dsrx_slv3_config_t slv3_config = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_emb_func_en_a_t emb_func_en_a = {0};
  int32_t ret = {0};
...
int32_t lsm6dsrx_pedo_step_detect_get(const stmdev_ctx_t *ctx,
                                      uint8_t *val)
{
  lsm6dsrx_emb_func_status_mainpage_t emb_func_status = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_pedo_cmd_reg_t pedo_cmd_reg = {0};
  int32_t ret = {0};
...
int32_t lsm6dsrx_motion_flag_data_ready_get(const stmdev_ctx_t *ctx,
                                            uint8_t *val)
{
  lsm6dsrx_emb_func_status_t emb_func_status = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t lsm6dsrx_mag_offset_set(const stmdev_ctx_t *ctx, const int16_t *val)
{
  uint8_t buff[6] = {0};
  int32_t ret = {0};
  uint8_t i = {0};
...
{
  lsm6dsrx_mag_cfg_a_t mag_cfg_a = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_mag_cfg_b_t mag_cfg_b = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_fsm_long_counter_clear_t fsm_long_counter_clear = {0};
  int32_t ret = {0};
                             ...
                             uint8_t *val)
{
  ...
  if (ret == 0)
  {
    ret = lsm6dsrx_read_reg(ctx, LSM6DSRX_FSM_OUTS1, val, 16);
  }
...
{
  lsm6dsrx_emb_func_odr_cfg_b_t emb_func_odr_cfg_b = {0};
  int32_t ret = {0};
                                            ...
                                            uint8_t *val)
{
  ...
  ret = lsm6dsrx_ln_pg_write_byte(ctx, LSM6DSRX_FSM_PROGRAMS, val);
                                            ...
                                            uint8_t *val)
{
  ...
  ret = lsm6dsrx_ln_pg_read_byte(ctx, LSM6DSRX_FSM_PROGRAMS, val);
...
{
  lsm6dsrx_emb_func_en_b_t reg = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_emb_func_odr_cfg_c_t reg = {0};
  int32_t ret = {0};
...
int32_t lsm6dsrx_mlc_out_get(const stmdev_ctx_t *ctx, uint8_t *val)
{
  ...
  if (ret == 0)
  {
    ret = lsm6dsrx_read_reg(ctx, LSM6DSRX_MLC0_SRC, val, 8);
  }
...
{
  lsm6dsrx_slv0_add_t slv0_add = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_slv1_config_t slv1_config = {0};
  lsm6dsrx_slv1_add_t slv1_add = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_slv2_config_t slv2_config = {0};
  lsm6dsrx_slv2_add_t slv2_add = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_slv3_config_t slv3_config = {0};
  lsm6dsrx_slv3_add_t slv3_add = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_s4s_tph_l_t s4s_tph_l = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_s4s_st_cmd_code_t s4s_st_cmd_code = {0};
  int32_t ret = {0};
...
{
  lsm6dsrx_s4s_dt_reg_t s4s_dt_reg = {0};
  int32_t ret = {0};
